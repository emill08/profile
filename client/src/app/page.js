      ...
      <div className="flex flex-col items-center pt-36">
        ...
        <div className="mt-6 px-4 lg:px-64">
          <p className="text-lg text-gray-700">
            Welcome to my Full Stack Developer portfolio! As a web enthusiast,
            I'm on a mission to create dynamic and user-friendly digital
            experiences. My portfolio showcases a collection of projects that
            demonstrate my ability to seamlessly integrate aesthetics with
            functionality. From designing intuitive user interfaces to
            engineering robust backend systems, I'm committed to delivering web
            solutions that stand out. Feel free to browse through my work.
          </p>
        </div>
        <Link
          href="/project"
          className="flex flex-row mt-32 btn-ghost p-2 rounded-xl"
        >
          <svg
